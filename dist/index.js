...
(() => {
  ...
  var getEmblaNodes = (parent) => Array.from((parent || document).querySelectorAll("[data-carousel-parent]"));
  var applyEmblaCarousel = (emblaNode) => {
    ...
    const emblaContainer = emblaNode.querySelector("[data-carousel-container]");
    if (!emblaContainer) {
      console.error("[data-carousel-container] wasn't found!");
      return;
    }
    const emblaSlides = Array.from(
      emblaContainer.querySelectorAll("[data-carousel-slide]")
    );
